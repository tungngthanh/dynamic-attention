...
class LearnableGlobalLocalTransformerDecoderMix(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out=None, incremental_state=None):
        ...
        return x, {'attn': attn, 'inner_states': inner_states}
        # return x, {'attn': attention_states, 'inner_states': inner_states}
...
@register_model_architecture('lgl_mix_encoder_decoder', 'lgl_mix_globallocal_block_cross_mix_globallocal_block_encoder_wmt_en_fr')
def lgl_mix_globallocal_block_cross_mix_globallocal_block_encoder_wmt_en_fr(args):
    lgl_wmt_en_fr(args)
    args.encoder_att_class = LearnableGlobalLocalMultiheadAttentionSelfAttentionBlock
    args.cross_att_class = LearnableGlobalLocalMultiheadAttentionSelfAttentionBlock
    args.decoder_att_class = MultiheadAttention
